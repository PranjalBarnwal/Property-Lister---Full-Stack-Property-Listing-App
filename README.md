# Property Lister - Full Stack Property Listing App

A modern, full-stack property listing application built with React Native and Expo for iOS, Android, and Web platforms.

## Features

- 🏠 Browse property listings with advanced search and filters
- 💼 Admin panel for property management
- 📍 Location-based property tagging with maps
